...
stat.ch <- replicate(2000, my_chisq_test(eva::rgpd(n, scale=theta[1], shape=theta[2]), B = 0,
                                         method = "minchisq"))
stat.ml <- replicate(2000, my_chisq_test(eva::rgpd(n, scale=theta[1], shape=theta[2]), B = 0,
                                         method = "ml"))
