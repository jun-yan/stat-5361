...
MASS::fitdistr(x, densfun = dfancy, start = list(shape = 10, scale = 20))
```
...
(fit <- stats4::mle(nll, start = list(shape = 10, scale = 10)))
summary(fit)
```
## Exercise
